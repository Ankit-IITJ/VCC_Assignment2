...
MY_IP="49.43.160.211/32"
SERVICE_ACCOUNT_EMAIL="default"
USER_EMAIL="m23csa509@iitj.ac.in"
...
# ---- FINAL OUTPUT -------------------------------------
echo "Setup complete! Load balancer IP:"
LB_IP=$(gcloud compute forwarding-rules describe web-forwarding-rule --global --format="value(IPAddress)")
echo "Load Balancer is available at: http://$LB_IP"
